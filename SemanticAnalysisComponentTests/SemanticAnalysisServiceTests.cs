...
{
    private static SemanticAnalysisService _semanticAnalysisService;
    ...
    public static void ClassInitialize(TestContext context)
    {
        ...
        _semanticAnalysisService = new SemanticAnalysisService(ollama, new PromptProvider());
